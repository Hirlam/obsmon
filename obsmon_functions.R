...
if ( Sys.info()["nodename"] == "hirlam" ){
  ...
  default_experiments <- c(default_experiments,"MetCoOp (old)","MetCoOp-backup (old)","MetCoOp-preop (old)")
# MetCoOp server
}else if (Sys.getenv('SMHI_DIST') != "linda4" && file.exists("/etc/profile.d/smhi.sh" )) {
  hostname="metcoop"
